...
export const DB32_CATEGORIES: Record<string, HexColour[]> = {
  monochromesAndDarkNeutrals: [
    COLOUR_PURE_BLACK, COLOUR_DARK_PURPLE_BLACK, COLOUR_DEEP_MAROON_BROWN, 
    COLOUR_DARK_RUST_BROWN, COLOUR_MEDIUM_EARTH_BROWN, COLOUR_VIBRANT_TERRACOTTA
  ],
  warmTonesAndHighlights: [
    COLOUR_PALE_CREAM, COLOUR_BRIGHT_LEMON_YEL, COLOUR_LIME_GREEN, 
    COLOUR_MID_MEADOW_GREEN, COLOUR_DEEP_FOREST_GREEN, COLOUR_WARM_SANDY_TAN
  ],
  richEarthsPinksAndReds: [
    COLOUR_MUTED_GOLD, COLOUR_FAIR_SKIN_PEACH, COLOUR_CORAL_RED, 
    COLOUR_DEEP_CRIMSON, COLOUR_ROYAL_PURPLE, COLOUR_CORNFLOWER_BLUE
  ],
  coolOceansAndSkies: [
    COLOUR_BRIGHT_SKY_BLUE, COLOUR_VIVID_TURQUOISE, COLOUR_ICE_BLUE, 
    COLOUR_PURE_WHITE, COLOUR_COOL_LIGHT_GRAY, COLOUR_MEDIUM_SLATE_GRAY, COLOUR_OLIVE_DRAB
  ],
  mutedShadowsAndFoliage: [
    COLOUR_DARK_OLIVE, COLOUR_DEEP_TEAL_BLACK, COLOUR_DARK_INDIGO, 
    COLOUR_NAVY_BLUE, COLOUR_CLASSIC_GRASS_GRN, COLOUR_NEUTRAL_MID_GRAY, COLOUR_DARK_WARM_GRAY
  ]
};
